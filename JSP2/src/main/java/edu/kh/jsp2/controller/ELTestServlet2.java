...
public class ELTestServlet2 extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		application.setAttribute("application", "application scope 객체에 세팅한 값");
		// applicationVlue=application scope 객체 세팅한 값
		...
		// key 값을 동일하게 하여 범위 별 객체에 값 추가
		req.setAttribute("menu", "짬뽕(reques)");
