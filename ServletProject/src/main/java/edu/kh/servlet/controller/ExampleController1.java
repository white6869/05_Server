...
// 응답을 해줄 서블릿 클래스 ExmapleController1을 만든다.
...
public class ExampleController1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// HttpServletRequest
		// - 클라이언트 요청 시 생성되는 객체
		// - 요청시 전달된 데이터, 요청한 클라이언트 정보,
		// 유연한 요청 처리를 위한 객체를 제공함.
		
		// HttpServletResponse
		// - 클라이언트 요청 시 생성되는 객체
		// - 서버가 클라이언트에게 응답하기 위한 방법을 제공함
		//  서버-> 클라이언트 쪽으로 만들어진 페이지를 제공하기 위해서
		...
		// HttpServletRespone 객체 이용
		
		//응답처리 1 : 응답하는 문서의 형식과 문장 인코딩 지정
		...
		// 응답처리 4 : 출력스트림을 이용해 클라이언트에게 HTML 코드 제공(응답)
